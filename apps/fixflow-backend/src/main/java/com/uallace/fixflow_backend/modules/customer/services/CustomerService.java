...
public class CustomerService {
    ...
    public Customer save(Customer customer) {
        if(customerRepository.findByCpf(customer.getCpf()).isPresent()) throw new RuntimeException("CPF já cadastrado");
        if(customerRepository.findByEmail(customer.getEmail()).isPresent()) throw new RuntimeException("Email já cadastrado");
